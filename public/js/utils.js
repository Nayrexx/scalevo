...
const Utils = {
  ...
  SLUG_BLACKLIST: [
    'app','www','admin','api','mail','ftp','blog','help','support','status',
    'docs','cdn','static','assets','store','shop','checkout','billing',
    'dashboard','login','signup','register','account','settings','scalevo',
  ],
  ...
  isValidSlug(slug) {
    ...
    if (this.SLUG_BLACKLIST.includes(slug)) return false;
    return true;
  },
  ...
  icon(name) {
    const icons = {
      ...
      'arrow-left': '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>',
